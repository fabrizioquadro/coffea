...
<div class="card card-border-shadow-primary mb-4">
    <div class="card-body">
        <div class="d-flex justify-content-between">
            <h4 class="card-title">Adicionar Unidade</h4>
        </div>
        <hr>
        <form action="{{ route('unidades.insert') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row mt-2 gy-4 align-items-end">
                ...
                <div class="col-md-6">
                    <div class="form-floating form-floating-outline">
                        <input required class="form-control" type="number" id="cod_sisagil" name="cod_sisagil"/>
                        <label for="cod_sisagil">Cod. Sisagil:</label>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-floating form-floating-outline">
                        <input required class="form-control" type="text" id="token_sisagil" name="token_sisagil"/>
                        <label for="token_sisagil">Token Sisagil:</label>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-floating form-floating-outline">
                        <input required class="form-control" type="text" id="usuario_sisagil" name="usuario_sisagil"/>
