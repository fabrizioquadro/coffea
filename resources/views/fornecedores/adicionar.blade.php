...
<div class="card card-border-shadow-primary mb-4">
    <div class="card-body">
        ...
        <hr>
        <form action="{{ route('fornecedores.insert') }}" method="post">
            @csrf
            <div class="row mt-2 gy-4">
                ...
                <div class="col-md-6">
                    <div class="form-floating form-floating-outline">
                        <input required class="form-control" type="text" id="cpf_cnpj" name="cpf_cnpj"/>
                        <label for="cpf_cnpj">CPF/CNPJ:</label>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-floating form-floating-outline">
                        <input required class="form-control" type="text" id="sisagil_id" name="sisagil_id"/>
                ...
                <div class="col-md-4">
                    <div class="form-floating form-floating-outline">
                        <input class="form-control" type="text" id="celular" name="celular" maxlength="15" onkeypress="mascara( this, mtel )"/>
