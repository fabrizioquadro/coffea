...
if($requisicao->qrcode()){
    $var = explode(" ", $requisicao->qrcode()->created_at);
    $dt_confirmacao = dataDbForm($var[0]);
}
...
<div class="card card-border-shadow-primary mb-4">
    <div class="card-body">
        ...
        <div class="row mt-3 gy-2">
            ...
            <div class="col-md-3 form-group borda_de_linha">
                <label for="">Data Solicitação:</label><br>
                <b>{{ $dt_criacao }}</b><br>
            </div>
        </div>
        <div class="row mt-2 gy-2">
            ...
            <div class="col-md-4 form-group borda_de_linha">
                <label for="data_previa_conclusao">Data Confirmação:</label><br>
                <b>{{ $dt_confirmacao }}</b>
            </div>
        </div>
        <div class="row mt-2 gy-2">
